<aside class="pe-app-sidebar" id="sidebar">
    <div class="pe-app-sidebar-logo px-6 d-flex align-items-center position-relative">
        <!--begin::Brand Image-->
        <a href="{{ route('documents.dashboard') }}" class="fs-18 fw-semibold">
    ...
    <nav class="pe-app-sidebar-menu nav nav-pills" data-simplebar id="sidebar-simplebar">
        <ul class="pe-main-menu list-unstyled">
            ...
            <li class="pe-slide pe-has-sub">
                <a href="{{ route('documents.modeles.index') }}" class="pe-nav-link">
                    <i class="bi bi-file-earmark-ruled pe-nav-icon"></i>
                    <span class="pe-nav-content">Modèles de documents</span>
                </a>
            </li>
            <li class="pe-slide pe-has-sub">
                <a href="{{ route('documents.generes.index') }}" class="pe-nav-link">
                    <i class="bi bi-files pe-nav-icon"></i>
                    <span class="pe-nav-content">Documents générés</span>
                </a>
            </li>
            <li class="pe-menu-title">
                Configuration
