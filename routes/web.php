...
// gestion des sociétés (PME) et des modules souscrits par chacune. Tout est volontairement
// préfixé /admin pour ne jamais partager un chemin identique avec routes/tenant.php (une route
// GET / ou GET /connexion strictement identique dans les deux fichiers se ferait sinon écraser
...
Route::prefix('admin')->name('central.')->middleware('auth:admin')->group(function () {
    Route::get('/', fn () => redirect()->route('central.societes.index'));
