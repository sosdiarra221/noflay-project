...
// Toutes les routes de l'application (une par société) : identifiées par sous-domaine,
// interdites sur les domaines centraux (takha.test, etc. — voir config/tenancy.php).
Route::middleware([
    'web',
